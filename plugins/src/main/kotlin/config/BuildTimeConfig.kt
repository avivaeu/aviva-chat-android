...
object BuildTimeConfig {
    const val APPLICATION_ID = "org.avivaeu.chat"
    const val APPLICATION_NAME = "Aviva Chat"
    ...
    val METADATA_HOST_REVERSED: String? = "org.avivaeu.chat"
    val OIDC_REDIRECT_URL: String? = "https://chat.avivaeu.org/oidc/login"
    val URL_WEBSITE: String? = "https://chat.avivaeu.org"
    val URL_LOGO: String? = "https://chat.avivaeu.org"
    val URL_COPYRIGHT: String? = "https://element.io/copyright"
    val URL_ACCEPTABLE_USE: String? = "https://chat.avivaeu.org"
    val URL_PRIVACY: String? = "https://chat.avivaeu.org"
    val URL_POLICY: String? = "https://chat.avivaeu.org"
